                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                        <p className="text-sm text-blue-900 dark:text-blue-200 text-center">
                            <strong>NRWD is a utility token</strong> for the
                            Nossa Rewards platform. It provides access to
                            rewards (such as promotional codes) and does not
                            grant holders any ownership rights, equity
                            participation, or rights to profits.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Powered by SIWE (EIP-4361), wagmi, and
                                ConnectKit
                            </p>
                        </div>
                    </div>
